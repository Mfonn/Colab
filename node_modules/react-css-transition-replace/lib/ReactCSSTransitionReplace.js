...
var ReactCSSTransitionReplace = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ReactCSSTransitionReplace, [{
    ...
    value: function enqueueHeightTransition() {
      if (!this.rafHandle) {
        this.rafHandle = (0, _animationFrame.request)(this.performHeightTransition);
      }
    }
  }, {
    key: "wrapChild",
    value: function wrapChild(child, moreProps) {
      ...
      return /*#__PURE__*/_react.default.createElement(_ReactCSSTransitionReplaceChild.default, _objectSpread({
        name: transitionName,
